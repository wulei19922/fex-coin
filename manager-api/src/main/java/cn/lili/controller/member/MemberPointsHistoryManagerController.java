...
public class MemberPointsHistoryManagerController {
    ...
    public ResultMessage<MemberPointsHistoryVO> getMemberPointsHistoryVO(String memberId, @PathVariable String pointClass) {
        return ResultUtil.data(memberPointsHistoryService.getMemberPointsHistoryVO(memberId,pointClass));
    }
