    ...
    public void orderChange(OrderMessage orderMessage) {
        ...
        switch (orderMessage.getNewStatus()) {
            ...
            case PAID:
                ...
                Order bySn = orderService.getBySn(orderSn);
                Double flowPrice = Math.floor(bySn.getFlowPrice());
                String memberId = bySn.getMemberId();
                memberService.updateMemberPointClass(flowPrice.longValue(), PointTypeEnum.INCREASE.name(), memberId, "订单"+orderSn+"付款，赠送积分" + flowPrice.longValue() + "分", PointEnum.POINT_C);
                break;
            case CANCELLED: {
